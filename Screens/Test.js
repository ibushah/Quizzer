...
export default class Test extends Component {
  ...
  gotoResultComp(score)
  {
    this.props.navigation.navigate("End",{score})
  }
      ...
      <View style={styles.container}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={{ marginTop: 30, padding: 5 }}>
            ...
            {!!this.state.questions.length && <Question ques={this.state.questions[key].question} />}
          </View>

          {!!this.state.questions.length && <Options gotoResultComp={this.gotoResultComp.bind(this)} submit={this.submit.bind(this)} option={this.state.questions[key]} />}

        </View>

        {/* <View style={styles.subBtnView}>

            <TouchableOpacity style={styles.subBtn} onPress={this.submit.bind(this)}>
