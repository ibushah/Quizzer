...
export default class Test extends Component {
  ...
  render() {
    const { key, showResultComponent, start, questions } = this.state;
    ...
    return (
      ...
      <View style={styles.container}>
        ...
        {start && <StartQuiz start={this.starter.bind(this)} />}

        {!!questions.length && !!!showResultComponent && !!!start && <View style={{ flex: 1 }}>
        ...
        {!!questions.length && !!showResultComponent && !!!start && <Result playAgain={this.playAgain.bind(this)} score={this.state.score} />}
